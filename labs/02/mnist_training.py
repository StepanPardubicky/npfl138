...
parser.add_argument(
    "--learning_rate_final", default=0.0001, type=float, help="Final learning rate."
)
parser.add_argument(
    "--momentum", default=None, type=float, help="Nesterov momentum to use in SGD."
)
parser.add_argument(
    "--optimizer", default="Adam", choices=["SGD", "Adam"], help="Optimizer to use."
)
parser.add_argument(
...
def main(args: argparse.Namespace) -> dict[str, float]:
    ...
    if args.decay == None:
        ...
        lr_schedule = keras.optimizers.schedules.CosineDecay(
            initial_learning_rate=args.learning_rate,
            decay_steps=decay_steps,
            alpha=args.learning_rate_final / argslearning_rate,
        )
    ...
    if args.optimizer == "SGD":
        if args.momentum == None:
            ...
            optimizer = keras.optimizers.SGD(
                lr_schedule, momentum=args.momentum, nesterov=True
            )
